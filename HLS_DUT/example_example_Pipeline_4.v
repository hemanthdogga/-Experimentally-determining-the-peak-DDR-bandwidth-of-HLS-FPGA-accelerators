...
reg   [0:0] exitcond117_reg_132;
reg   [31:0] buffa_load_reg_146;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] loop_index3_cast_fu_105_p1;
wire    ap_block_pp0_stage0_01001;
reg   [10:0] loop_index3_fu_50;
wire   [10:0] empty_18_fu_99_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond117_fu_93_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index3_fu_50 <= empty_18_fu_99_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index3_fu_50 <= 11'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        exitcond117_reg_132 <= exitcond117_fu_93_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond117_reg_132 == 1'd0))) begin
        buffa_load_reg_146 <= buffa_q0;
    end
end
...
always @ (*) begin
    if (((exitcond117_fu_93_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (exitcond117_reg_132 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ...
        ap_sig_allocacmp_loop_index3_load = loop_index3_fu_50;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_a_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_a_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end
...
assign buffa_address0 = loop_index3_cast_fu_105_p1;

assign empty_18_fu_99_p2 = (ap_sig_allocacmp_loop_index3_load + 11'd1);

assign exitcond117_fu_93_p2 = ((ap_sig_allocacmp_loop_index3_load == 11'd1024) ? 1'b1 : 1'b0);

assign loop_index3_cast_fu_105_p1 = ap_sig_allocacmp_loop_index3_load;
...
assign m_axi_a_RREADY = 1'b0;

assign m_axi_a_WDATA = buffa_load_reg_146;

assign m_axi_a_WID = 1'd0;

assign m_axi_a_WLAST = 1'b0;

assign m_axi_a_WSTRB = 4'd15;
