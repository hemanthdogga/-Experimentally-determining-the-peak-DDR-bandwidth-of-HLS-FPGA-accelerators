...
//------------------------Parameter----------------------
`define TV_IN_b "D:/VITISplay/using_axi_master/Simulation/tv/cdatafile/c.example.autotvin_b.dat"
`define TV_OUT_b "D:/VITISplay/using_axi_master/Simulation/tv/rtldatafile/rtl.example.autotvout_b.dat"
 parameter b_ADDR_BITWIDTH = 32'd 64;
 parameter b_AWUSER_BITWIDTH = 32'd 1;
 parameter b_DATA_BITWIDTH = 32'd 32;
 parameter b_WUSER_BITWIDTH = 32'd 1;
 parameter b_ID_BITWIDTH = 32'd 1;
 parameter b_RUSER_BITWIDTH = 32'd 1;
 parameter b_BUSER_BITWIDTH = 32'd 1;
...
input clk;
input reset;
input  TRAN_b_AWVALID;
output  TRAN_b_AWREADY;
input [b_ADDR_BITWIDTH - 1 : 0] TRAN_b_AWADDR;
input [b_ID_BITWIDTH - 1 : 0] TRAN_b_AWID;
input [8 - 1 : 0] TRAN_b_AWLEN;
input [3 - 1 : 0] TRAN_b_AWSIZE;
input [2 - 1 : 0] TRAN_b_AWBURST;
input [2 - 1 : 0] TRAN_b_AWLOCK;
input [4 - 1 : 0] TRAN_b_AWCACHE;
input [3 - 1 : 0] TRAN_b_AWPROT;
input [4 - 1 : 0] TRAN_b_AWQOS;
input [4 - 1 : 0] TRAN_b_AWREGION;
input [b_AWUSER_BITWIDTH - 1 : 0] TRAN_b_AWUSER;
input  TRAN_b_WVALID;
output  TRAN_b_WREADY;
input [b_DATA_BITWIDTH - 1 : 0] TRAN_b_WDATA;
input [b_DATA_BITWIDTH/8 - 1 : 0] TRAN_b_WSTRB;
input  TRAN_b_WLAST;
input  TRAN_b_WID;
input [b_WUSER_BITWIDTH - 1 : 0] TRAN_b_WUSER;
input  TRAN_b_ARVALID;
output  TRAN_b_ARREADY;
input [b_ADDR_BITWIDTH - 1 : 0] TRAN_b_ARADDR;
input [b_ID_BITWIDTH - 1 : 0] TRAN_b_ARID;
input [8 - 1 : 0] TRAN_b_ARLEN;
input [3 - 1 : 0] TRAN_b_ARSIZE;
input [2 - 1 : 0] TRAN_b_ARBURST;
input [2 - 1 : 0] TRAN_b_ARLOCK;
input [4 - 1 : 0] TRAN_b_ARCACHE;
input [3 - 1 : 0] TRAN_b_ARPROT;
input [4 - 1 : 0] TRAN_b_ARQOS;
input [4 - 1 : 0] TRAN_b_ARREGION;
input  TRAN_b_ARUSER;
output  TRAN_b_RVALID;
input  TRAN_b_RREADY;
output [b_DATA_BITWIDTH - 1 : 0] TRAN_b_RDATA;
output  TRAN_b_RLAST;
output [b_ID_BITWIDTH - 1 : 0] TRAN_b_RID;
output [b_RUSER_BITWIDTH - 1 : 0] TRAN_b_RUSER;
output [2 - 1 : 0] TRAN_b_RRESP;
output  TRAN_b_BVALID;
input  TRAN_b_BREADY;
output [2 - 1 : 0] TRAN_b_BRESP;
output [b_ID_BITWIDTH - 1 : 0] TRAN_b_BID;
output [b_BUSER_BITWIDTH - 1 : 0] TRAN_b_BUSER;
input ready;
input done;

// Inner signals
// AW request fifo
reg    [b_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [b_ADDR_BITWIDTH - 1 : 0]         FIFO_AW_req_ADDR_tmp; 
...
// AR request fifo
reg    [b_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR           [0 : FIFO_DEPTH - 1]; 
reg    [b_ADDR_BITWIDTH - 1 : 0]         FIFO_AR_req_ADDR_tmp; 
...
// WDATA fifo
reg    [b_DATA_BITWIDTH - 1 : 0]         FIFO_WDATA           [0 : FIFO_DEPTH - 1]; 
reg    [b_DATA_BITWIDTH/8 - 1 : 0]       FIFO_WSTRB           [0 : FIFO_DEPTH - 1]; 
...
reg    BRESP_tmp = 0;
reg    [b_ID_BITWIDTH - 1 : 0] BID_tmp = 0;
reg    send_one_BRESP = 0;
reg    [31 : 0] BRESP_counter = 0;

reg [b_DATA_BITWIDTH - 1:0] RDATA_tmp = 0;
reg [2 - 1:0] RRESP_tmp = 0;
reg RLAST_tmp = 0;
reg RVALID_tmp = 0;
reg [b_ID_BITWIDTH - 1 : 0] RID_tmp = 0;
reg [b_DATA_BITWIDTH - 1 : 0] b_mem_0 [0: b_mem_depth - 1] = '{default : 'h0}; 
reg [b_DATA_BITWIDTH - 1 : 0] b_mem_1 [0: b_mem_depth - 1] = '{default : 'h0}; 
reg [b_DATA_BITWIDTH - 1 : 0] b_mem_2 [0: b_mem_depth - 1] = '{default : 'h0}; 
reg [31 : 0] clk_counter ;
reg [31 : 0] current_AW_req_transaction = 0 ;
reg [31 : 0] current_AR_req_transaction = -1 ;
reg write_processing = 0;
reg [b_ADDR_BITWIDTH - 1 : 0] wr_processing_addr = 0;
reg [b_ADDR_BITWIDTH - 1 : 0] rd_processing_addr = 0;
reg [31 : 0] wr_processing_trans_num = 0;
reg [b_DATA_BITWIDTH - 1 : 0] wr_processing_data = 0;
assign TRAN_b_AWREADY    =    !FIFO_AW_req_full; 
assign TRAN_b_ARREADY    =    !FIFO_AR_req_full; 
assign TRAN_b_WREADY    =     !(FIFO_WDATA_req_full || FIFO_WDATA_size_full); 
assign TRAN_b_BVALID = (BRESP_counter == 0) ? 0 : 1;
assign TRAN_b_BRESP = BRESP_tmp;
assign TRAN_b_BID = BID_tmp;
assign TRAN_b_RDATA = RDATA_tmp;
assign TRAN_b_RRESP = RRESP_tmp;
assign TRAN_b_RLAST = RLAST_tmp;
assign TRAN_b_RID = RID_tmp;
assign TRAN_b_RVALID = RVALID_tmp;

initial begin : initialize_offset
  integer DATA_byte_num; 
  integer c_bitwidth;
  DATA_byte_num = 0; 
  c_bitwidth = b_C_DATA_BITWIDTH;
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_b_AWREADY & TRAN_b_AWVALID ) begin    // RTL is sending a AW_request to the bus         
            FIFO_AW_req_SIZE [FIFO_AW_req_ptr_w]    =   TRAN_b_AWSIZE; 
            FIFO_AW_req_ADDR [FIFO_AW_req_ptr_w]    =   TRAN_b_AWADDR; 
            FIFO_AW_req_LEN  [FIFO_AW_req_ptr_w]    =   TRAN_b_AWLEN; 
            FIFO_AW_req_BURST[FIFO_AW_req_ptr_w]    =   TRAN_b_AWBURST; 
            FIFO_AW_req_ID[FIFO_AW_req_ptr_w]    =   TRAN_b_AWID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_b_ARREADY & TRAN_b_ARVALID ) begin    // RTL is sending a AR_request to the bus         
            FIFO_AR_req_SIZE [FIFO_AR_req_ptr_w]    =   TRAN_b_ARSIZE; 
            FIFO_AR_req_ADDR [FIFO_AR_req_ptr_w]    =   TRAN_b_ARADDR; 
            FIFO_AR_req_LEN  [FIFO_AR_req_ptr_w]    =   TRAN_b_ARLEN; 
            FIFO_AR_req_BURST[FIFO_AR_req_ptr_w]    =   TRAN_b_ARBURST; 
            FIFO_AR_req_ID[FIFO_AR_req_ptr_w]    =   TRAN_b_ARID; 
...
always @ (posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if(TRAN_b_WREADY & TRAN_b_WVALID) begin    // RTL is sending a WDATA data 
            FIFO_WDATA [FIFO_WDATA_req_ptr_w]    <=   TRAN_b_WDATA; 
            FIFO_WSTRB [FIFO_WDATA_req_ptr_w]    <=   TRAN_b_WSTRB; 
            if(FIFO_WDATA_req_ptr_w != FIFO_DEPTH - 1) 
                FIFO_WDATA_req_ptr_w <= FIFO_WDATA_req_ptr_w + 1; 
            else 
                FIFO_WDATA_req_ptr_w <= 0; 
            if (TRAN_b_WLAST == 1 ) begin
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_b_AWVALID && TRAN_b_AWREADY && ((FIFO_AW_req_ptr_w - FIFO_AW_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AW_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_b_ARVALID && TRAN_b_ARREADY && ((FIFO_AR_req_ptr_w - FIFO_AR_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
          FIFO_AR_req_flag <= 1; 
      # 0.4;
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_b_WVALID && TRAN_b_WREADY && ((FIFO_WDATA_req_ptr_w - FIFO_WDATA_req_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
      ...
      if(TRAN_b_WVALID && TRAN_b_WREADY && TRAN_b_WLAST && ((FIFO_WDATA_size_ptr_w - FIFO_WDATA_size_ptr_r) % FIFO_DEPTH == FIFO_DEPTH - 1)) 
...
always @(posedge clk or reset) begin 
    if(reset === 0) begin 
        ...
        if ( send_one_BRESP == 'b1 && !(BRESP_counter != 32'h0 && TRAN_b_BREADY) ) begin
            BRESP_counter <= BRESP_counter + 1;
        end else if (send_one_BRESP != 'b1 && (BRESP_counter != 32'h0 && TRAN_b_BREADY)) begin
            BRESP_counter <= BRESP_counter - 1;
        end
    end
end
...
initial begin : AW_request_proc
    ...
    reg [b_DATA_BITWIDTH - 1 : 0] FIFO_WDATA_tmp;
    reg [b_DATA_BITWIDTH - 1 : 0] WDATA_tmp;
    reg [b_DATA_BITWIDTH/8 - 1 : 0] FIFO_WSTRB_tmp;
    @(posedge clk);
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > b_mem_depth) begin
                $display ("D:/VITISplay/using_axi_master/vitis1/solution1/sim/verilog/AESL_axi_master_b.v: Write request address %d exceed AXI master b array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, b_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AW_req_BURST_tmp === 1) begin
                ...
                while (counter != output_length + 1) begin
                    if (FIFO_WDATA_req_empty != 1) begin 
                            ...
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = b_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        1 : WDATA_tmp[j] = b_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                                        2 : WDATA_tmp[j] = b_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter][j];
                        ...
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : b_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            1 : b_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            2 : b_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size + counter] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
                    ...
                    if (FIFO_WDATA_req_empty != 1) begin 
                        ...
                        for (i = 0 ; i < data_byte_size; i = i + 1) begin
                            if (FIFO_WSTRB_tmp[i] == 1) begin 
                                ...
                                for (j=(i*8); j< (i+1)*8 ; j= j+1) begin
                                    case(FIFO_AW_req_transaction_tmp % mem_page_num)
                                        0 : WDATA_tmp[j] = b_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        1 : WDATA_tmp[j] = b_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        2 : WDATA_tmp[j] = b_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size][j];
                                        default: $display("The page_num of AXI write is not valid!");
                                    endcase
                                end
                            end
                        ...
                        wr_processing_data = WDATA_tmp;
                        case(FIFO_AW_req_transaction_tmp % mem_page_num)
                            0 : b_mem_0[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            1 : b_mem_1[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            2 : b_mem_2[FIFO_AW_req_ADDR_tmp / data_byte_size] <= WDATA_tmp;
                            default: $display("The page_num of AXI write is not valid!");
                        endcase
...
initial begin : AR_request_proc
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > b_mem_depth) begin
                $display ("D:/VITISplay/using_axi_master/vitis1/solution1/sim/verilog/AESL_axi_master_b.v: Read request address %d exceed AXI master b array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, b_mem_depth); 
                $finish;
            end
            ...
            if (FIFO_AR_req_BURST_tmp === 1) begin
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= b_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            1 : RDATA_tmp <= b_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                            2 : RDATA_tmp <= b_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size +   counter] ;
                    ...
                    @(posedge clk);
                    if (RVALID_tmp && TRAN_b_RREADY) begin
                        counter = counter + 1;
                    end 
                end
                RVALID_tmp <= 0;
                ...
                while (counter != input_length + 1) begin
                    ...
                    if ((write_processing == 1) && (wr_processing_addr == rd_processing_addr) && (wr_processing_trans_num == FIFO_AR_req_transaction_tmp))
                        ...
                        case(FIFO_AR_req_transaction_tmp % mem_page_num)
                            0 : RDATA_tmp <= b_mem_0[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            1 : RDATA_tmp <= b_mem_1[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            2 : RDATA_tmp <= b_mem_2[FIFO_AR_req_ADDR_tmp / data_byte_size ] ;
                            default: $display("The page_num of AXI read is not valid!");
                        endcase
                    RVALID_tmp <= 1;
                    RRESP_tmp <= 0;
...
initial begin : read_file_process 
  ...
  reg [b_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  integer i; 
  transaction_num = 0;
  b_bitwidth = b_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (b_bitwidth , factor);
  fp = $fopen(`TV_IN_b,"rb"); 
  ...
  while (trans_depth != 64'h5a5aa5a50f0ff0f0)  begin
      ...
      mem_tmp [b_DATA_BITWIDTH - 1: 0] = 0;
      for(i = 0; i < b_mem_depth; i = i + 1) begin 
          ...
          if (factor == 4) begin
              ...
              if (i%factor == 3) begin
                  ...
                  case(mem_page)
                      0 : b_mem_0[i/factor] = mem_tmp;
                      1 : b_mem_1[i/factor] = mem_tmp;
                      2 : b_mem_2[i/factor] = mem_tmp;
...
initial begin : write_file_proc 
  ...
  integer mem_page; 
  integer b_bitwidth; 
  reg [b_C_DATA_BITWIDTH - 1 : 0] mem_tmp; 
  reg [b_DATA_BITWIDTH - 1 : 0] tmp_data;
  reg [63:0] bin_data;
  transaction_num = 0; 
  b_bitwidth = b_C_DATA_BITWIDTH; 
  count_seperate_factor_by_bitwidth (b_bitwidth , factor);
  while(1) begin 
      ...
      mem_page = transaction_num % mem_page_num ;
      # 0.1;
      fp = $fopen(`TV_OUT_b, "ab"); 
      if(fp == 0) begin       // Failed to open file 
          $display("Failed to open file \"%s\"!", `TV_OUT_b); 
          $finish; 
      end 
      bin_data = b_mem_depth;
      write_binary(fp,bin_data,64);
      for(i = 0; i < (b_mem_depth - b_mem_depth % factor); i = i + 1) begin 
          if (factor == 4) begin
              case(mem_page)
                  0 : tmp_data = b_mem_0[i/factor];
                  1 : tmp_data = b_mem_1[i/factor];
                  2 : tmp_data = b_mem_2[i/factor];
      ...
      if (factor == 4) begin
          case(mem_page)
              0 : tmp_data = b_mem_0[b_mem_depth/factor];
              1 : tmp_data = b_mem_1[b_mem_depth/factor];
              2 : tmp_data = b_mem_2[b_mem_depth/factor];
              default: $display("The page_num of write file is not valid!");
          endcase
          if ((b_mem_depth - 1) % factor == 2) begin
          ...
          if ((b_mem_depth - 1) % factor == 1) begin
              bin_data = tmp_data[7:0];
              write_binary(fp,bin_data,8);
              bin_data = tmp_data[15:8];
              write_binary(fp,bin_data,8);
          end
          if ((b_mem_depth - 1) % factor == 0) begin
              bin_data = tmp_data;
              write_binary(fp,bin_data,8);
          end
      end
      if (factor == 2) begin
          if ((b_mem_depth - 1) % factor == 0) begin
              case(mem_page)
                  0 : tmp_data = b_mem_0[b_mem_depth/factor][15:0];
                  1 : tmp_data = b_mem_1[b_mem_depth/factor][15:0];
                  2 : tmp_data = b_mem_2[b_mem_depth/factor][15:0];
                  default: $display("The page_num of write file is not valid!");
              endcase
              bin_data = tmp_data;
              write_binary(fp,bin_data,16);
